...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Nov 2022 pada 01.33
...
('PL00001', 'tes1 tes3', 'tes@gmail.cpm', '123', '123', 'aktif', 'Internet Lite', 150000, '2022-11-13'),
('PL00002', '1', '1', '1', '1', 'non aktif', 'Internet dedicated', 150000, '2022-11-13'),
('PL00003', 'tes2', 'tes@gmaol.com', '1', '1', 'non aktif', 'Internet Lite', 100000, '2022-11-13');
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_ibfk_1` (`kode_produk`),
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_ibfk_1` FOREIGN KEY (`kode_produk`) REFERENCES `produk` (`kode_produk`) ON DELETE CASCADE ON UPDATE CASCADE,
