...
<head>
	<meta charset="utf-8">
	<title>Fans Vision Jember</title>
...
<section class="navbar navbar-fixed-top custom-navbar" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="http://103.124.138.254/" class="navbar-brand">Fans Vision Jember</a>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<h3>INTERNET SERVICE PROVIDER / NETWORKED CABLE TELEVISION / BROADCAST</h3>
				<h1>NETWORK & BROADCAST TEAM</h1>
				<hr>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.9s">
				<i class="icon-desktop medium-icon"></i>
					<h3>NETWORKED CABLE TELEVISION</h3>
					<hr>
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="active"><a href="#design" aria-controls="design" role="tab" data-toggle="tab">INTERNET</a></li>
					<li><a href="#mobile" aria-controls="mobile" role="tab" data-toggle="tab">CABLE TV</a></li>
					<li><a href="#social" aria-controls="social" role="tab" data-toggle="tab">BROADCAST</a></li>
				</ul>
				<!-- tab panes -->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 text-center">
				<div class="section-title">
					<strong>05</strong>
					<h1 class="heading bold">INTERNET PRICING</h1>
					<hr>
				</div>
			</div>
				<?php 	
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12 contact-info">
				...
				<p>For more information and bookings contact us</p>
				<div class="col-md-6 col-sm-4">
					<h3><i class="icon-envelope medium-icon wow bounceIn" data-wow-delay="0.6s"></i> EMAIL</h3>
					<p>fansvision2020@gmail.com</p>
				</div>
				<div class="col-md-6 col-sm-4">
					<h3><i class="icon-phone medium-icon wow bounceIn" data-wow-delay="0.6s"></i> PHONES & WHATSAPP</h3>
					<p>+6281231877443 | +6282231678985</p>
				</div>
			</div>
...
<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<p>Copyright © Fans Vision Jember | 2021</p>
				<hr>
				<ul class="social-icon">
